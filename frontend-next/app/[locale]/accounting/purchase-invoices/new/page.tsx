...
import { 
  ...
  DollarSign, Percent, AlertCircle, ArrowLeft, Calculator
} from 'lucide-react';
  ...
  const handleSubmit = async (status: 'draft' | 'submitted') => {
    ...
    try {
      ...
      const response = await authenticatedFetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/v1/accounting/purchase-invoices`,
        {
          method: 'POST',
      ...
      toast.success(`Purchase invoice ${status === 'draft' ? 'saved as draft' : 'submitted'} successfully`);
      router.push(`/accounting/purchase-invoices/${data.id}`);
    } catch (error) {
      ...
      <div className="mb-8">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">Create a new vendor invoice</p>
          </div>
        </div>
      </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sticky top-8">
            ...
            <div className="space-y-3">
              ...
              <Link href="/accounting/purchase-invoices"
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-yellow-700 mt-1">
                    Draft invoices can be edited later. Submitted invoices require approval before payment.
                  </p>
                </div>
              </div>
            </div>
